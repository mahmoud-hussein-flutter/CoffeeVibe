class CoffeeItem {
  ...
  static List<CoffeeItem> mockItems = [
    CoffeeItem(
        ...
        name: 'Iced Americano',
        description:
            'Prepared by combining our signature espresso with water and pouring it over ice to chill: All the flavour of your favorite brew, minus the heat.',
    ...
    CoffeeItem(
        ...
        description:
            'In many parts of the world, chai simply means tea, but in North America the word has come to be shorthand for masada chai, a traditional Indian spiced tea like the one offered by Tazo.',
